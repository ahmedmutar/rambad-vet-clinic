...
use App\Exports\LaporanKeuanganHarianPetShop;

class LaporanKeuanganHarianPetshopController extends Controller
{
    ...
    public function download_report(Request $request)
    {
        ...
        return (new LaporanKeuanganHarianPetShop($request->orderby, $request->column, $request->date, $request->branch_id))
