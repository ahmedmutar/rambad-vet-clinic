$(document).ready(function () {
  if (role.toLowerCase() == "resepsionis") {
    ...
    $("#section-foto-kondisi-pasien").magnificPopup({
      delegate: "a",
      type: "image",
    });
  }
  ...
  function loadDetailHasilPemeriksaan(paramId) {
    $.ajax({
      ...
      success: function (data) {
        ...
        $("#anamnesaDetailTxt").text(getData.anamnesa);
        $("#diagnosaDetailTxt").text(getData.diagnosa);
        ...
        if (getData.images.length) {
          getData.images.forEach((img) => {
            rowFotoKondPasien += `<a href="${
              $(".baseUrl").val() + img.image
            }"><div class="img-style"><img src=${
              $(".baseUrl").val() + img.image
            }></div></a>`;
          });
        } else {
