$(document).ready(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#usiaHewanTahunTxt").text(
            `${data.registration.pet_year_age} Tahun`
          );
          $("#usiaHewanBulanTxt").text(
            `${data.registration.pet_month_age} Bulan`
          );
          ...
          $("#statusPemeriksaanTxt").text(
            data.status_finish ? "Selesai" : "Belum"
          );
  ...
  $("#btnSubmitPembayaran").click(function () {
    ...
    $("#modal-confirmation .box-body").text(
      "Anda yakin ingin menyimpan Pembayaran ini? Data yang akan anda tambahkan tidak dapat diubah kembali."
    );
  ...
  function processSaved() {
    ...
    $.ajax({
      ...
      success: function (resp) {
        ...
        processPrint(
          $("#selectedPasien").val(),
          JSON.stringify(finalSelectedJasa),
          JSON.stringify(finalSelectedBarang)
        );
  ...
  function processAppendListTagihanJasa() {
    ...
    if (listTagihanJasa.length) {
      ...
      rowListTagihanJasa += `<tr class="text-center"><td colspan="8">Tidak ada data.</td></tr>`;
    }
  ...
  function processAppendListTagihanBarang() {
    ...
    if (listTagihanBarang.length) {
      ...
      rowListTagihanBarang += `<tr class="text-center"><td colspan="10">Tidak ada data.</td></tr>`;
    }
  ...
  function validationForm() {
    ...
    $("#btnSubmitPembayaran").attr(
      "disabled",
      !isValidSelectedPasien || !isValidCalculationPay || isBeErr ? true : false
    );
  }
