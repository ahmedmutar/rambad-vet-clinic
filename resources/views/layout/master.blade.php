...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	<link rel="shortcut icon" type="image/jpg" href="{{ asset('assets/image/rambadlogo.jpg') }}">
  <!-- Bootstrap 3.3.7 -->
    ...
    <input class="baseUrl" type="hidden" value="{{ url('/') }}"/>
		<header class="main-header">
			...
			<a href="{{ url('/') }}" class="logo">
				...
				<span class="logo-mini"><b>R</b>VC</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>RAMBAD</b> <b>VET</b> CLINIC</span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="/">Rambad Vet Clinic</a></strong> | Powered by Scoop Tech
		</footer>
