...
<div class="box box-info" id="laporan-keuangan-Mingguan-app">
  <div class="box-header">
    <h3 class="box-title">Laporan Keuangan Mingguan Petshop</h3>
...
@section('script-content')
  <script src="{{ asset('main/js/laporan-keuangan-petshop/mingguan/mingguan.js') }}"></script>
  <script src="{{ asset('bower_components/moment/min/moment.min.js') }}"></script>
  <script src="{{ asset('bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/laporan-keuangan-petshop.css') }}">
