...
<div class="modal fade" id="modal-tambah-petshop">
	<div class="modal-dialog">
      ...
      <div class="modal-footer">
        <button id="btnSubmitPetshop" type="button" class="btn btn-primary pull-right m-r-10px" title="Simpan dan Unduh PDF">Simpan & Unduh</button>
      </div>
    </div>
  </div>
</div>
